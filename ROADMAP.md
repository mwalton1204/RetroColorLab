...
Working task list for RetroColorLab, in no particular order.
...
- **Palette folders** — organize saved palettes into user-defined folders for easier library management
